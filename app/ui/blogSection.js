...
function BlogSection() {
  return (
    <section className="mx-auto h-fit w-screen  pb-3 lg:max-w-8xl flex-col bg-white lg:h-840">
      ...
      <div className="mx-auto h-fit w-9/11 lg:max-w-7xl">
        <HomepageBlogs />
      </div>
      <div className="mx-auto pt-20 h-fit w-fit">
        <BlogsLink />
      </div>
    </section>
  );
